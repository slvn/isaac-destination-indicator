...
function characterYOffset(self)
    repeat
        local ____switch22 = __TS__OptionalMethodCall(
            Isaac.GetPlayer(),
            "GetPlayerType",
            false
        )
        local ____cond22 = ____switch22 == PlayerType.PLAYER_JACOB
        if ____cond22 then
            return 13
        end
        ____cond22 = ____cond22 or ((____switch22 == PlayerType.PLAYER_BETHANY) or (____switch22 == PlayerType.PLAYER_BETHANY_B))
        if ____cond22 then
            return 8
        end
        do
...
function inputAction(self, _entity, _inputHook, _buttonAction)
